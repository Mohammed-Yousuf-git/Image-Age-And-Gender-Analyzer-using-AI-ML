{
 "cells": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 4,
   "id": "d07a53bf-c1f5-4c70-8cca-fb7b3d53359f",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
   ...
   "source": [
    ...
    "    dataframe=train_df,\n",
    "    directory=\"/mnt/data/faces_dataset/Train/\",\n",
    "    x_col='ID',\n",
    "    y_col='Class',\n",
    ...
    "\n",
    "# Save model\n",
    "model.save(\"models/age_classifier.h5\")\n",
    "\n",
